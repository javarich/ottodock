...
insert into otto_user (email, password, admin, first_name, last_name)
values ('otto@ottodock.com', 'ptl', true, 'Otto','Admin');
insert into otto_user (email, password, admin, first_name, last_name)
values ('rich@ottodock.com', 'ptl', true, 'Rich','Admin');
insert into otto_user (email, password, admin, first_name, last_name)
values ('tom@ottodock.com', 'ptl', true, 'Tom','Admin');
